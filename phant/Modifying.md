...
Incidentally, yes, the preceding is incomplete and vague. That's
...
(If it doesn't, make sure you're running a *very* recent
...
You won't need to modify the wiztool object, but you *will* need
to add a line like
